...
## Files
- `retail_sales_analysis.ipynb` — Python notebook with cleaning and analysis
- `dataset.csv` — dataset used for analysis https://www.kaggle.com/datasets/mohammadtalib786/retail-sales-dataset 
- `images/` — saved charts and visuals
